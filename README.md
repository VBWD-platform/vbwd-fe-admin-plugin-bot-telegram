# vbwd-fe-admin-plugin-bot-telegram

> vbwd fe-admin plugin: bot-telegram-admin

**Type:** Admin frontend plugin · **Host app:** `vbwd-fe-admin` · **Plugin:** `bot-telegram`
